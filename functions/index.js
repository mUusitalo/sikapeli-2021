...
const verifyGamestate = functions
    ...
    .onCall(async (args, context) => {
        ...
        await new Promise(a => setTimeout(a, Math.random() * 3000))
        ...
        */
        ...
        try {
            ...
            logger.log("Error in buildGamestate: ", {error: e.message, oldGamestate, modifications, idleTimeAfterModifications, auth: context.auth})
            return oldGamestate
        }
