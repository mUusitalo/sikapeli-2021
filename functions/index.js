 ...
 */
const verifyGamestateV2 = onCall({
	cors: true,
	...
	const { modifications = [], idleTimeAfterModifications = 0 } = args.data;
	...
	*/
	let {
		...
		clickCount = 0
	} = await readFromDatabase(args.auth) ?? {}
	...
	*/
	try {
		...
		error("Error in testTimeAndClicks: ", { error: e.message, oldGamestate, modifications, idleTimeAfterModifications, auth: args.auth })
		return oldGamestate
	}
	...
	try {
		...
		error("Error in buildGamestate: ", { error: e.message, oldGamestate, modifications, idleTimeAfterModifications, auth: args.auth })
		return oldGamestate
	}
...
module.exports = { verifyGamestateV2 }
