...
const Game = ({uid, db}) => {
    ...
    return (
        <>
            <div id='game'>
                <div id="counter">
                    <div id='bacon-counter'>{gamestate.formatNumber((gamestate[GamestateVariables.PEKONI])*Math.pow(10, 3), 5)} <img class="counter-icon" src={Icons[GamestateVariables.PEKONI]}/></div>
